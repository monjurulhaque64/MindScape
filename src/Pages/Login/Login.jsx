                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex justify-center">
                                <input type='submit' className="px-4 py-2 text-white bg-purple-500 rounded-lg hover:bg-purple-600 focus:outline-none focus:ring focus:ring-purple-500" value="Log In" />
                            </div>
                        </form>
