...
const Footer = () => {
    useEffect(() => {
        const logoElement = document.querySelector('.logo-name');
        ...
        <footer>
            <div className="footer p-10 bg-base-300 text-base-content">
                <div>
                    ...
                    <p>MindScape Organization.<br />Providing reliable tech since 1992</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>House: 1/2, Road: 5, Black: A, <br />
                            Section: 1, Mirpur, Dhaka</p>
                    </div>
                </div>
